  ...
  try {
    ...
    if (shouldUseCloudinary) {
      ...
      try {
        ...
        imageData = convertCloudinaryToUploadedImage(
          cloudinaryResult,
          alt,
          file.name
        );
        ...
        imageData = await handleLocalUpload(
          buffer,
          file,
          alt,
          userId,
